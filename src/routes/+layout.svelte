...
<div class="flex h-screen bg-gray-950 text-gray-100 overflow-hidden">
    <aside
        class="w-56 bg-gray-900 border-r border-gray-800 flex flex-col flex-shrink-0"
    >
        ...
        <nav class="flex-1 overflow-y-auto p-2">
          ...
          {$page.url.pathname === '/'
            ...
            {#each navSections as section}
                <div class="mb-4">
                    <p
                        class="text-gray-600 text-xs font-semibold uppercase tracking-wider px-2 mb-1"
                    >
                        {section.label}
                    </p>
